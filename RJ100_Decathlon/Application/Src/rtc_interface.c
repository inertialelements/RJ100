 ...
 *
 */
 /* @brief This file contains functions to update the rtc with real time clock
  *
  */
...
/* @brief Initializes the calendar library. Run this before calling any other functions.
 *
 */
...
/* @brief Enables a callback feature in the calendar library that can call a function automatically at the specified
 * interval (seconds).
 *
 */
...
/*@brief Sets the date and time stored in the calendar library.
...
/* @brief  Returns the uncalibrated time as a tm struct. :
 *
 */
...
/*@brief Returns the calibrated time as a tm struct. If no calibration data is available it will return the uncalibrated time.
 *
 */
...
/*@brief Returns a string for printing the date and time. Turn the calibration on/off by setting the calibrate parameter.
 *
 */
